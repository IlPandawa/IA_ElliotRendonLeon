...
class DecisionTreeModel(ModelInterface):
    def __init__(self):
        super().__init__()
        self.model_name = "Árbol de Decisión"
        self.model = None
        self.scaler = None
        self.model_file = 'C:\\InteligenciaArtificial\\IA_ElliotRendonLeon\\Proyecto2(pyGame Phaser)\\models\\modelosGuardados\\dt_model.pkl'
        self.scaler_file = 'C:\\InteligenciaArtificial\\IA_ElliotRendonLeon\\Proyecto2(pyGame Phaser)\\models\\modelosGuardados\\dt_scaler.pkl'
    ...
    def predict(self, velocidad_bala, distancia):
        ...
        try:
            ...
            # Para clasificación, obtener probabilidad de clase positiva
